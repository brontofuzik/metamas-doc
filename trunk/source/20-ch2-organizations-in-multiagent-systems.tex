...
We are facing the challenge of carrying these \textit{organizational concepts} over to the realm of MASes.

% No standardized way to impose organizational structure upon MASes
Unfortunately, there is no standardized way to impose organizational structure upon MASes.
...
% ACMAS vs. OCMAS
In the next two sections, we will introduce two ways of looking at MASes:
\begin{itemize}
