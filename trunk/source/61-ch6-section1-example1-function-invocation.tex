...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{images/examples/example1-stage1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{images/examples/example1-stage2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{images/examples/example1-stage3.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{images/examples/example1-stage4.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{images/examples/example1-stage5.png}
