...
The authors of \textit{powerJade} merged the models in \cite{Boella04} (organization strucure) and \cite{Boella04} (role dynamics) into a unified metamodel.
...
Roles in \textit{powerJade} can be compared to interfaces from OOP.
